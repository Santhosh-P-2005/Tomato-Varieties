...
const PusaHybrid8Tomato = () => {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        <Text style={styles.title}>Pusa Hybrid 8</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.subtitle}>Suitable Soil:</Text>
        <View style={styles.list}>
          <Text style={styles.listItem}>Type: Hybrid tomatoes like Pusa Hybrid 8 typically thrive in well-drained loamy soil with good organic content.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Optimal Growing Temperature: Hybrid tomatoes prefer temperatures between 20°C to 30°C for vigorous growth and fruit development.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Disease Resistance: Hybrid tomatoes often exhibit improved resistance to common tomato diseases such as early blight, late blight, and Fusarium wilt compared to heirloom varieties.</Text>
...
export default PusaHybrid8Tomato;
