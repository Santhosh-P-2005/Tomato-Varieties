  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        <Text style={styles.title}>Campari Tomato</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.subtitle}>Suitable Soil:</Text>
        <View style={styles.list}>
          <Text style={styles.listItem}>Type: Campari tomatoes prefer well-drained loamy soil with good organic content.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Optimal Growing Temperature: Campari tomatoes thrive in temperatures ranging from 20°C to 30°C.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Planting Time: Campari tomatoes can be planted in different seasons depending on the regional climate.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Disease Resistance: Campari tomatoes may exhibit some resistance to common tomato diseases such as early blight, late blight, and Fusarium wilt.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Common Pests: Aphids, whiteflies, thrips, and fruit borers are common pests that affect Campari tomatoes.</Text>
