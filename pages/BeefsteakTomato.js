...
const BeefsteakTomato = () => {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        <Text style={styles.title}>Beefsteak Tomato</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.subtitle}>Suitable Soil:</Text>
        <View style={styles.list}>
          <Text style={styles.listItem}>Type: Beefsteak tomatoes prefer well-drained loamy soil with good organic content.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Optimal Growing Temperature: Beefsteak tomatoes thrive in temperatures ranging from 20°C to 30°C.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Planting Time: Beefsteak tomatoes can be planted in different seasons depending on the regional climate.</Text>
        ...
        <Text style={styles.paragraph}>Harvesting: Expect a harvest timeline of approximately 70-90 days from transplanting, with fruit production continuing throughout the growing season.</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.subtitle}>Disease Resistance and Management:</Text>
        <View style={styles.list}>
          <Text style={styles.listItem}>Disease Resistance: Beefsteak tomatoes may exhibit some resistance to common tomato diseases such as early blight, late blight, and Fusarium wilt.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Common Pests: Beefsteak tomatoes are susceptible to pests such as aphids, whiteflies, thrips, and fruit borers.</Text>
