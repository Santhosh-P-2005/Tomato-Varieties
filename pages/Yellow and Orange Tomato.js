...
const YellowOrangeTomato = () => {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        <Text style={styles.title}>Yellow and Orange Tomato</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.subtitle}>Suitable Soil:</Text>
        <View style={styles.list}>
          <Text style={styles.listItem}>Type: Yellow and orange tomatoes prefer well-drained loamy soil with good organic content.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Optimal Growing Temperature: Yellow and orange tomatoes thrive in temperatures ranging from 20°C to 30°C.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Planting Time: Yellow and orange tomatoes can be planted in different seasons depending on the regional climate.</Text>
        ...
        <Text style={styles.paragraph}>Harvesting: Expect a harvest timeline of approximately 70-80 days from transplanting, with fruit production continuing throughout the growing season.</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.subtitle}>Disease Resistance and Management:</Text>
        <View style={styles.list}>
          <Text style={styles.listItem}>Disease Resistance: Yellow and orange tomatoes may exhibit some resistance to common tomato diseases such as early blight, late blight, and Fusarium wilt.</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>Common Pests: Aphids, whiteflies, thrips, and fruit borers are common pests that affect yellow and orange tomatoes.</Text>
...
export default YellowOrangeTomato;
